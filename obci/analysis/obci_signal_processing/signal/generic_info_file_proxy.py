...
class GenericInfoFileWriteProxy(object):
    ...
    Init method gets a dictionary of signal params in format understadable by InfoFileProxy.
    See __init__ metod for more details.
    ...
    def finish_saving(self, p_signal_params={}):
        ...
        So, how can I implement a new parameter usage? Let`s say that the parameter is signal`s colour.
        Let`s call it 'color', values are strings.
