...
class Ui_OBCILauncher(object):
    ...
    def setupUi(self, OBCILauncher):
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/filefind.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSelectAmplifier.setIcon(icon7)
        self.actionSelectAmplifier.setObjectName("actionSelectAmplifier")
    ...
    def retranslateUi(self, OBCILauncher):
        ...
        self.actionSelectAmplifier.setToolTip(
            _translate("OBCILauncher", "Search for available amplifiers and select one", None))
